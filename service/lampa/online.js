(function() {
  ...
  if (Defined.rchtype === undefined) {
    ...
    if (Lampa.Platform.is('android') || Lampa.Platform.is('tizen')) check(true);
      ...
      net.silent('https://durex.monster'.indexOf(location.host) >= 0 ? 'https://github.com/' : 'https://durex.monster/cors/check', function() {
        check(true);
      }, function() {
        check(false);
      }, false, {
  ...
  function component(object) {
    ...
    this.rch = function(json, noreset) {
      ...
      if (typeof signalR == 'undefined') {
        Lampa.Utils.putScript(["https://durex.monster/signalr-6.0.25_es5.js"], function() {}, false, function() {
          load();
        }, true);
      } else load();
    };
